...
public:
    ...
    */
     ...
     */
    void geopotential(Vector3d<Dimension::Acceleration> &acc, Vector3d<double> &torque, const StateVector &state, double et) const;
     ...
     */
    void drag(Vector3d<Dimension::Acceleration> &acc, Vector3d<double> &torque, const StateVector &state, double et, double elapsed_time) const;
     ...
     *  @param[in] et				Ephemeris time.
     */
    void solar_radiation_pressure(Vector3d<Dimension::Acceleration> &acc, Vector3d<double> &torque, const StateVector& state, const double et) const;
     ...
     *  @param[in] et				Ephemeris time.
     */
    void magnetic_perturbations(Vector3d<double> &torque, const StateVector &state, double et) const;
     ...
     *  @param[in] et				Ephemeris time.
     */
    void third_body_effect(Vector3d<Dimension::Acceleration> &acc, const StateVector &state, double et) const;
